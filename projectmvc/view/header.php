      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav search-right mt-lg-0 mt-2">
            ...
            <li class="nav-item"><a href="bookride" class="btn btn-primary d-none d-lg-block btn-style mr-2">Book ride
              </a>
            </li>
          </ul>
        <?php } else {  ?>
          ...
          <ul class="navbar-nav search-right mt-lg-0 mt-2">
            <li class="nav-item mr-3" title="Search"><a href="#search" class="btn search-search">
                <span class="fa fa-search" aria-hidden="true"></span></a></li>
            <li class="nav-item"><a href="Contact" class="btn btn-primary d-none d-lg-block btn-style mr-2">Contact Us
              </a></li>
          </ul>
        <?php } ?>
